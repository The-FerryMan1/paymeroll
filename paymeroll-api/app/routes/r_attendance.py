...
async def create_attendance(
    attendance: AttendanceCreate, db: Session = Depends(get_db.getDB)
):
...
async def get_all_attendances(
    ...
    return c_attendance.get_all_attendance(db, skip, limit)
...
async def get_attendance(
    ...
    return c_attendance.get_attendance(db, attendance_id)
...
async def get_emp_attendance(
    ...
    return c_attendance.get_emp_attendances(db, employee_id)
...
def update_attendance(
    ...
    return c_attendance.update_clock_out(db, attendance_id, time_out.time_out)
...
def delete_attendance(
    ...
    return c_attendance.delete_attendance(db, attendance_id)
